...
export default function Marketing() {
  return (
    <>
    <section className="bg-white dark:bg-white w-screen">
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-black">Marketing</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-black">Business Automation</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-black">Enterprise Design</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-black">Operations</h3>
